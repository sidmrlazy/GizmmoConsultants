...
const GizmmoPpt = () => {
  const FILE_PATH =
    'https://gizmmoalchemy.com/api/consultancy/documents/Gizmmo.pdf';
  ...
  return (
    <>
      <Pressable style={styles.tab} onPress={checkPermissions}>
        <Icons name="laptop-outline" size={25} color="#0077B6" />
        <Text style={styles.tabTxt}>Gizmmo Consultants Presentation</Text>
      </Pressable>
    </>
  );
};

export default GizmmoPpt;
